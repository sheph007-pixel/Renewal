...
- Networks and doctors: every Gravie plan is on Cigna's Open Access Plus (OAP) network. When the client asks whether a doctor, hospital or clinic is in network on a Gravie plan, or where to check, give Cigna's public directory: https://hcpdirectory.cigna.com/web/public/consumer/directory/search?consumerCode=HDC001 — and say to search it as Open Access Plus. Gravie's pharmacy benefit manager (PBM) is Express Scripts; when the client asks whether a drug is covered or what tier it is on a Gravie plan, give the formulary: https://www.express-scripts.com/frontend/open-enrollment/gravie. For any other carrier's network or formulary, say the account manager can send the link.
