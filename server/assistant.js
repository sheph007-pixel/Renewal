...
- The portal's pages, which you may point to by name: Welcome (the letter, with What's Changing For 2027 — today against 2027, the headline — below it); Assistant (this); Medical Plans, which has two tabs — Current 2026 Medical Plans (what is in force today, with rates and the employer/employee split) and New 2027 Medical Options (every quoted plan side by side, with a contribution modeler); Supplemental Package (dental, vision, life, disability and the rest); Sign Up (shortlist plans and send a note to Kennion to start the renewal).
