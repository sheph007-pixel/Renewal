...
export interface AdminGroup {
  ...
  /** How the name reads on the group's own pages, when staff set one. Copy only. */
  displayName?: string | null;
  /** How the effective date reads on the group's pages, when staff set one. Copy only. */
